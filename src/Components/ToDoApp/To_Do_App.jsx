        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="input-row flex flex-col sm:flex-row gap-4 mb-6">
            <input
              ...
              className={`flex-1 px-4 py-3 rounded-lg shadow-sm border-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all ${
                isDarkMode
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full sm:w-40 px-4 py-3 rounded-lg shadow-sm border-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all ${
                isDarkMode
                  ? "bg-gray-800 text-white border-gray-700"
                  : "bg-white text-gray-900 border-gray-300"
              } ${validation ? "border-red-500" : "border-indigo-500"}`}
          ...
          <div className="tags flex flex-wrap gap-2 mb-8">
            {tags.map((tag, i) => (
              <div
                ...
                className={`cursor-pointer px-4 py-2 rounded-full font-medium text-sm shadow-sm transition-all duration-200 ${
